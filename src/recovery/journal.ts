...
import { createObservation, type CreateObservationInput } from '../db/observations.js';
import { createKnowledge, type CreateKnowledgeInput } from '../db/knowledge.js';
 ...
 */
export function journaledInsertObservation(input: CreateObservationInput): Observation {
  return withJournal(
    'insert_observation',
    'observations',
 ...
 */
export function journaledInsertKnowledge(input: CreateKnowledgeInput): Knowledge {
  return withJournal(
    'insert_knowledge',
    'knowledge',
    '', // record id assigned inside createKnowledge; replay uses payload
    input,
    () => {
