...
export function getThresholds(projectId) {
    const db = getDb();
...
export function recordAutoStash(projectId) {
    const db = getDb();
    db.prepare(`
 ...
 */
export function recordFalsePositive(projectId) {
    const db = getDb();
    db.prepare(`
    UPDATE adaptive_thresholds
...
export function recordSuggestionShown(projectId) {
    const db = getDb();
    db.prepare(`
    UPDATE adaptive_thresholds
...
export function recordSuggestionAccepted(projectId) {
    const db = getDb();
    db.prepare(`
    UPDATE adaptive_thresholds
