import { getActiveConversation, createConversation, stashConversation, } from '../db/conversations.js';
 ...
 */
export async function handleTopicShift(sessionId, projectPath, projectId, newActivity) {
    ...
    const newConversation = createConversation(sessionId, projectPath, result.newTopic ?? undefined);
 ...
 */
export function ensureConversation(sessionId, projectPath, topic) {
